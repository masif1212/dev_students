  ...
  <Provider store={store}>
    <NavigationContainer>
      ...
      <Stack.Screen name="Home" component={Home} options={{headerShown: false,headerStyle: {backgroundColor: "white",}}}/>
        ...
        />
        <Stack.Screen name="DrawerScreen" component={Drawer} options={{ hederaShadowVisible: false, headerShown: false, headerStyle: {backgroundColor: "white",},}}/>
        <Stack.Screen name="SelectedSchool" component={SelectedSchoolScreen} options = {({route}) => ({title: route.params.title , headerShadowVisible: false, headerShown: true, headerStyle: {backgroundColor: "#F5F5F5", }})}/>
        <Stack.Screen name="TeachersProfile" component={TeachersProfileScreen} options={{headerShadowVisible: false,headerStyle: {backgroundColor: "white",},}}/> 
        <Stack.Screen name="TeachersList" component={TeachersListScreen} options={{headerShadowVisible: false, headerStyle: { backgroundColor: "white", }, }}  />
        <Stack.Screen name="StudentDetail" component={StudentDetail} options={{ headerShadowVisible: false, headerTintColor:'black',  headerStyle: {  backgroundColor: "white",   }, }}/>
        <Stack.Screen name="SchoolAdminHomePage" component={SchoolAdminHomePage} options={{  headerShadowVisible: false,  headerStyle: { backgroundColor: "white",  },  }}  />
        <Stack.Screen name="TeachersListForSchoolAdmin" component={TeachersListForSchoolAdmin} options={{  headerShadowVisible: false,  headerStyle: {  backgroundColor: "#5062BD", }, }}/>
        <Stack.Screen  name="AddTeacherForm"  component={AddTeacherForm} options={{ headerShadowVisible: false, headerStyle: { backgroundColor: "#5062BD",  }, }}/>
        <Stack.Screen name="ViewFullAttendance" component={ViewFullAttendance} options={{ headerShadowVisible: false,  headerStyle: { backgroundColor: "#5062BD", }, }}  />
        <Stack.Screen name="ClassStudents" component={ClassStudents} options={{  headerShadowVisible: false,headerStyle: {  backgroundColor: "white", }, }} />
        ...
        <Stack.Screen  name="CreateStudentForm"  component={CreateStudentForm} options={{ headerShadowVisible: false, headerStyle: { backgroundColor: "#5062BD", },  }}  />
        <Stack.Screen  name="SchoolAdminDrawer"  component={SchoolAdminDrawer}  options={{ headerShadowVisible: false,  headerShown:true, headerStyle: {  backgroundColor: "#5062BD",  }, }} />
        <Stack.Screen name="TeacherDrawer" component={TeacherDrawer} options={{ headerShadowVisible: false,  headerShown:false, headerStyle: { backgroundColor: "white", }, }}/>
        <Stack.Screen name="MarkAttendanceFilter"  component={MarkAttendanceFilter} options={{ headerShadowVisible: false, headerShown:false,headerStyle: { backgroundColor: "white", },  }} />
