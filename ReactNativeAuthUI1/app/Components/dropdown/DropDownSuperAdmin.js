...
export default DropDownSuperAdmin = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setCountries([
        {title: 'Punjab', cities: [{title: 'Lahore'}, {title: 'Okara'}]},
        {title: 'Sindh', cities: [{title: 'Karachi'}, {title: 'Gambat'}]},
        {title: 'kPK', cities: [{title: 'Mansehra'}, {title: 'Muzaffrabad'}]},
        {title: 'Balochistan', cities: [{title: 'Lahore'}, {title: 'Okara'}]},
      ]);
    }, 1000);
  }, []);
