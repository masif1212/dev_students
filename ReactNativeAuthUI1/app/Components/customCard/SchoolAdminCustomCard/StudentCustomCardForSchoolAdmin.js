...
import Pie from '../SchoolAdminCustomCard/StudentPieCharForSchoolAdmin';

const StudentCustomCardForSchoolAdmin = ({title,backgroundColor,color}) => {
...
export default StudentCustomCardForSchoolAdmin
