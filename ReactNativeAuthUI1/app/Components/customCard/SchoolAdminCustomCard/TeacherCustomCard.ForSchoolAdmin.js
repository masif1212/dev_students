...
import Pie from '../SchoolAdminCustomCard/TeacherPieChartForSchoolAdmin';

const TeacherCustomCardForSchoolAdmin = ({title,backgroundColor,color}) => {
                ...
                <View style={{  }}>
                    ...
                    <View>
                          <View style={{ flexDirection: 'row', }}>
                           ...
                           <View style={{flexDirection:'row', }}>
                                 <View style={{ width: 40, height: 15, backgroundColor: 'red' }} />
...
export default TeacherCustomCardForSchoolAdmin
